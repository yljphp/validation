...
class Validator
{
     ...
     * The messages.
     *
     * @var \Yljphp\Validation\MessageBag
     */
    protected $messages;
    ...
    {
        if ($extensions) {
            $keys = array_map('Yljphp\Validation\snake_case', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('Yljphp\Validation\snake_case', array_keys($replacers));
     ...
     *
     *
     * @return \Yljphp\Validation\MessageBag
     */
